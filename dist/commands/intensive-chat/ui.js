...
const App = ({ sessionId, title, outputDir, timeoutSeconds }) => {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        Text,
        { bold: true, color: 'magentaBright', wrap: 'wrap' },
        title,
      ),
      React.createElement(Text, { color: 'gray' }, 'Session ID: ', sessionId),
      React.createElement(
        Text,
        { color: 'gray' },
      ...
      React.createElement(
          ...
          // Use slice().reverse().find() for broader compatibility instead of findLast()
          {
            ...
            question:
              chatHistory
                .slice()
                .reverse()
                .find((m) => m.isQuestion && !m.answer)?.text || '',
        ...
        timeLeft !== null &&
          React.createElement(
            ...
            React.createElement(ProgressBar, { value: percentage }),
          ),
      ),
  );
};
